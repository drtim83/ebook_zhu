...
You (Antigravity) are part of a multi-agent team. Other active agents: Cline.
...
Write votes to `consensus/active/{task_id}-antigravity-{session_frag}.json`, where
...
```jsonc
{
  "from": "operator", "to": "antigravity", "type": "operator_message",
  "payload": {
...
```jsonc
{
  "id": "...", "from": "antigravity", "to": "operator", "type": "answer",
