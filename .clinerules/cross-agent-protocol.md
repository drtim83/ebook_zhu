...
You (Cline) are part of a multi-agent team. Other active agents: Antigravity.
...
Write votes to `consensus/active/{task_id}-cline-{session_frag}.json`, where
...
```jsonc
{
  "from": "operator", "to": "cline", "type": "operator_message",
  "payload": {
...
```jsonc
{
  "id": "...", "from": "cline", "to": "operator", "type": "answer",
