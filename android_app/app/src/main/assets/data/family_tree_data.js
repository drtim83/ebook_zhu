...
(function() {
  const treeNodes = [
    ...
    {
      id: "gen19_mingcan",
      name: "祝明灿 (Zhu Mingcan / 铭灿)",
      pinyin: "Zhù Míngcàn",
      gen: 19,
      genName: "19th Generation · Current Generation (十九世)",
      genChar: "明",
      fatherId: "gen18_shengjin",
      branch: "Gaolong Direct Line",
      location: "Gaolong Village ➔ International",
      page: 44,
      notes: "19th Generation torchbearer recorded on Pages 44–45. First son of Zhu Shengjin. Focal point of the contemporary Zhu family lineage.",
      isCore: true,
      isCurrentUser: true
    },
    {
    ...
    },
    {
      ...
      branch: "Gaolong Direct Line",
      location: "Global Lineage",
      page: 44,
      notes: "20th Generation ('Yun' / 运) carrying forward the lineage code into the modern era.",
      isCore: true
    },
    {
      id: "gen20_yunfu",
